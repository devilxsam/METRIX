...
class Telegram:
    ...
    BOT_USERNAME = env.get("TELEGRAM_BOT_USERNAME", "METRIX14BOT")
    BOT_TOKEN = env.get("TELEGRAM_BOT_TOKEN", "7118408917:AAG0SG-jRBxZYAa18U1xEw73MoPjd4E0SYg")
    CHANNEL_ID = int(env.get("TELEGRAM_CHANNEL_ID", -1002037467055))
